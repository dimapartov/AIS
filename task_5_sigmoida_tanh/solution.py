...
# Вычисление значений функции сигмоида в заданных точках с 15 знаками после запятой
...
# Сохранение графиков гиперболических функций
plt.tight_layout()
plt.savefig('2_hyperbolic_functions_plot.png')
...
plt.legend()
plt.tight_layout()
plt.savefig('3_derivatives_plot.png')
