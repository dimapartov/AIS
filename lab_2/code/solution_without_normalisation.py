...
# Предсказание градиентным спуском без нормализации
ax.scatter(engine_speed_input, num_gears_input, predicted_price_gd_no_norm[0],
           color='orange', s=100, label='Предсказание (Градиентный спуск без нормализации)')

# Предсказание градиентным спуском с нормализацией
ax.scatter(engine_speed_input, num_gears_input, predicted_price_gd_norm[0],
           color='red', s=100, label='Предсказание (Градиентный спуск с нормализацией)')
